...
(function() {
  ...
  */
  ...
  angular.module('angularCmsApp', ['ngCookies', 'ngResource', 'ngSanitize', 'ngRoute', 'ngAnimate']).config(function($routeProvider) {
    var routeResolver;
    routeResolver = {
  ...
  angular.module('angularCmsApp').controller('AppCtrl', [
    '$scope', '$rootScope', '$http', '$log', '$route', '$location', '$routeParams', '$cookieStore', function($scope, $rootScope, $http, $log, $route, $location, $routeParams, $cookieStore) {
      var App;
      App = Config;
      ...
      angular.element(document).ready(function() {
        ...
        return angular.element('.sidebar-nav').bind('click', 'a', function(e) {
          return $log.info(e);
        });
      });
      return $log.info($rootScope);
    }
  ]);
